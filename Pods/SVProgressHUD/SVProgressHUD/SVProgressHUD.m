...
static const CGFloat SVProgressHUDParallaxDepthPoints = 1.0f;
...
-(UIView *)backgroundView {
    ...
    switch (self.defaultMaskType) {
        ...
        case SVProgressHUDMaskTypeBlack:{
            ...
            _backgroundView.backgroundColor = self.defaultMaskType == SVProgressHUDMaskTypeCustom ? self.backgroundLayerColor : [UIColor colorWithWhite:0 alpha:0.15];
            break;
        }
